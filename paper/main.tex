...
\end{itemize}
Figure \ref{Fig:comparison} presents the comparison of the result of the two approaches, each column illustrating a different reference position.
...
The present contribution discussed a novel local Wave Field Synthesis approach, relying on a suitable filter transformation that allows derivation of a temporal filter bank from an arbitrary spatial filter.
