...
The two methods are compared via the exemplary synthesis scenario discussed in the foregoing, synthesizing an impulsive plane wave.
The result of synthesis for four different reference positions are investigated:
\begin{itemize}
