...
Obviously, for a closed SSD contour the continuous spatial Fourier-transform yields a discrete spectrum, consisting of non-zero components only on the multiples of the spatial period length, i.e. at
\begin{equation}
    k_s = m \frac{ 2 \pi }{R_0},
\end{equation}
